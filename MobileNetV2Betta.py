# -*- coding: utf-8 -*-
"""
Created on Thu Feb  2 05:33:36 2023
...
MODEL_NETWORK_NAME = "MobileNetBetta"
...
model.add(Dense(numclasses,activation="softmax",name="output-layer"))
