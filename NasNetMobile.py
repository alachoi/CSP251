# -*- coding: utf-8 -*-
"""
Created on Sat Jan 21 01:44:26 2023
...
from tensorflow.keras.layers import Conv2D, MaxPooling2D,GlobalAveragePooling2D,AveragePooling2D,SeparableConv2D
...
MODEL_NETWORK_NAME = "NasNetMobileBetta"
...
# Create a NASNetMobile model
base_model = NASNetMobile(weights='imagenet', include_top=False,input_tensor=input_tensor)
